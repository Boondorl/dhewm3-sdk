...
idCVar g_armorProtection(			"g_armorProtection",		"0.5",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "armor takes this percentage of damage" );
...
idCVar g_infiniteAmmo(				"g_infiniteAmmo",			"0",			CVAR_GAME | CVAR_INTEGER | CVAR_CHEAT, "type of infinite ammo");
...
idCVar pm_airTics(					"pm_air",					"2813",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_INTEGER, "how long in frames (62.5fps by default) the player can go without air before he starts taking damage" );
