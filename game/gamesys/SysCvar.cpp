...
idCVar pm_airTics(					"pm_air",					"3750",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_INTEGER, "how long in frames (62.5/sec by default) the player can go without air before he starts taking damage" );
