...
public:
	...
	void					RadiusDamage( const idVec3 &origin, idEntity *inflictor, idEntity *attacker, idEntity *fullDamage, idEntity *ignorePush, const char *damageDefName, float dmgPower = 1.0f );
