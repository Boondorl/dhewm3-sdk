...
public:
	...
	void					RadiusDamage( const idVec3 &origin, idEntity *inflictor, idEntity *attacker, idEntity *ignoreDmg, idEntity *ignorePush, const char *damageDefName, float dmgPower = 1.0f, idEntity *fullDamage = NULL );
